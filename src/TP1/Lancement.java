...
public class Lancement {
	...
	System.out.println( info);
		...
		System.out.println("Les cours de L1 : " + info.selectionnerCours(c -> c.getNiveau().equals(Niveau.L1)));
		System.out.println("Les cours de Simonot : " + info.selectionnerCours(c -> c.getResponsable().getNom().equals("Simonot")));
    }
}
